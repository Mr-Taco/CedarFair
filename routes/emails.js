...
module.exports = {
    'partnerships-form' : function (req,res,callback) {
        console.log('render partnership' , callback);
        callback();
    }
    ,'groupsales-form' : function (req,res,callback) {
        callback();
    }
    ,'media-form' : function (req,res,callback) {
        callback();
    }
};
